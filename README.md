...
Программа принимает на вход PDF документ с содержанием русского/белорусского/украинского/английского языков, далее при помощи Paddle OCR распознает его содержимое. Содержимое документа подается на вход к одной из моделей на выбор: Phi2 (~ 3 млр. параметров) или Mistral7b (7 миллиардов параметров), после на выход выдается текст с запросами к базе данных согласно указанной пользователем схеме БД. Сочетает в себе элементы тонкой настройки и обращение к схеме БД пользователя.
